...
public class AdminPagesController {
    ...
    public String add(@ModelAttribute Page page) {
        // @ModelAttribute("x") Page page --> the name of object will be x and i must call it in view like it name = x
    	// in case of default without name it will be name of object and i must call it in view like it name = page 
